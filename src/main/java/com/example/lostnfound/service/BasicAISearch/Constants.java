...
public class Constants {
    ...
    public final String TableInfo = DatabaseUtils.getTableAndColumnNames(Post.class);
    public final String HeaderMsgForGemini = "Hey Gemini, Read the user's message given below and database table info then create a postgresql query by following some steps given at the end of this message\n";
    public final String FooterMsgForGemini = "Steps:\n" +
